...
This document defines the process, conventions, and guidelines for creating and managing RFCs (Requests for Comments) in the context-harness project.
...
RFCs are the authoritative specifications for the context-harness system. They define:
...
context-harness RFCs fall into three kinds, each with a distinct purpose and level of abstraction:
...
**For questions about RFC management, contact the context-harness core team.**